...
public class ContactFetcher {
    ...
    public void matchContactNumbers(Map<String, Contact> contactsMap) {
        ...
        Cursor phone = new CursorLoader(context, Phone.CONTENT_URI, numberProjection, null, null,
    ...
    public void matchContactEmails(Map<String, Contact> contactsMap) {
        ...
        Cursor email = new CursorLoader(context, Email.CONTENT_URI, emailProjection, null, null,
                null).loadInBackground();
